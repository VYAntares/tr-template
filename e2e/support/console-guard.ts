 ...
 * defect worth failing the build over, so this is deliberately strict: any
 * console error, any console warning, any uncaught exception and any failed
 * request fails the route.
 */
