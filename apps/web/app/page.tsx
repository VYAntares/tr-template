    ...
    <div className="flex flex-col gap-12">
      <section className="flex flex-col gap-4">
        <h1 className="text-3xl font-semibold tracking-tight text-balance sm:text-4xl">
          A template app with the wiring already done
        </h1>
        <p className="max-w-prose text-base leading-relaxed text-slate-600 dark:text-slate-300">
          template-app is a starting point, not a product: two runtimes behind one origin, a shared
          contract package, a database and cache, and the build, test and deployment pipeline that
          keeps them honest. This page is the skeleton. Replace it with yours.
        </p>
      </section>
